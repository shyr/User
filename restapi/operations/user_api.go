...
func (o *UserAPI) ConsumersFor(mediaTypes []string) map[string]runtime.Consumer {
	...
	for _, mt := range mediaTypes {
		...
		case "application/joinc.user-address.v1+json":
			result["application/joinc.user-address.v1+json"] = o.JSONConsumer
...
func (o *UserAPI) ProducersFor(mediaTypes []string) map[string]runtime.Producer {
	...
	for _, mt := range mediaTypes {
		...
		case "application/joinc.user-address.v1+json":
			result["application/joinc.user-address.v1+json"] = o.JSONProducer
